...
var x = setInterval(function() {
  ...
  document.getElementById("Christmas").innerHTML = days + " Days " + hours + " Hours "
  + minutes + " Min " + seconds + " Sec ";
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("Christmas").innerHTML = "Selamat Hari Raya Natal ";
  }
}, 1000);
